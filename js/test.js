 ...
 */ (function (a, b) {function h(a) {
...
}(jQuery), function (a, b) {function c(b, c) {
    ...
    }), a.each(["Width", "Height"], function (c, d) {function h(b, c, d, f) {
    ...
    a.fn.position = function (b) {
        ...
        var g = a(b.of),
            h = g[0],
            i = (b.collision || "flip").split(" "),
            j = b.offset ? b.offset.split(" ") : [0, 0],
            k, l, m;
        return h.nodeType === 9 ? (k = g.width(), l = g.height(), m = {
            ...
            var c = a(this),
                d = c.outerWidth(),
                f = c.outerHeight(),
                g = parseInt(a.curCSS(this, "marginLeft", !0)) || 0,
                h = parseInt(a.curCSS(this, "marginTop", !0)) || 0,
                n = d + g + (parseInt(a.curCSS(this, "marginRight", !0)) || 0),
                o = f + h + (parseInt(a.curCSS(this, "marginBottom", !0)) || 0),
                p = a.extend({}, m),
                q;
    ...
    a.widget("ui.sortable", a.ui.mouse, {
        ...
        _mouseCapture: function (b, c) {
            ...
            a.data(b.target, "sortable-item") == e && (d = a(b.target));
            if (!d) return !1;
    ...
    a.widget("ui.dialog", {
        ...
        _makeDraggable: function () {function f(a) {
                return {
                    position: a.position,
                    offset: a.offset
                }
        ...
        _makeResizable: function (c) {function h(a) {
                return {
...
}(jQuery), function (a, b) {function e() {
        return ++c
    }function f() {
        return ++d
    }
    ...
    a.widget("ui.tabs", {
        ...
        _tabify: function (c) {function m(b, c) {
            ...
            this.anchors.bind(e.event + ".tabs", function () {
                ...
                if (!g.length) throw "jQuery UI Tabs: Mismatching fragment identifier.";
...
var Transformie = {
    ...
    centerOrigin: "margin",
    toRadian: function (a) {
        return a.indexOf("deg") != -1 ? parseInt(a, 10) * (Math.PI * 2 / 360) : a.indexOf("grad") != -1 ? parseInt(a, 10) * (Math.PI / 200) : parseInt(a, 10)
    },
    bindChangeEvent: function (a) {
        jQuery(a).unbind("propertychange").bind("propertychange", function (a) {
            (a.originalEvent.propertyName == "style.webkitTransform" || a.originalEvent.propertyName == "style.MozTransform" || a.originalEvent.propertyName == "style.transform") && Transformie.refreshMatrix(this, Transformie.resolveCSSKey(this.style))
        })
    },
    resolveCSSKey: function (a) {
        return a["-webkit-transform"] || a["webkit-transform"] || a.transform || a.webkitTransform || a["-moz-transform"] || a["moz-transform"] || a.MozTransform || a.mozTransform
    },
    parseStylesheets: function () {},
    refreshMatrix: function (a, b) {
        if (a.indexOf && a.indexOf(":hover") != -1) return;
        var c = b.match(/[A-z]+\([^\)]+/g) || [],
            d = [];
        ...
        if (!d.length) return;
        var j = d[0];
        for (var e = 0; e < d.length; e++) d[e + 1] && (j = d[e].x(d[e + 1]));
        jQuery(a).each(function () {
            this.filters["DXImageTransform.Microsoft.Matrix"] || (this.style.filter = (this.style.filter ? "" : " ") + "progid:DXImageTransform.Microsoft.Matrix(sizingMethod='auto expand')", Transformie.bindChangeEvent(this)), this.filters["DXImageTransform.Microsoft.Matrix"].M11 = j.elements[0][0], this.filters["DXImageTransform.Microsoft.Matrix"].M12 = j.elements[0][1], this.filters["DXImageTransform.Microsoft.Matrix"].M21 = j.elements[1][0], this.filters["DXImageTransform.Microsoft.Matrix"].M22 = j.elements[1][1], Transformie.centerOrigin && (this.style[Transformie.centerOrigin == "margin" ? "marginLeft" : "left"] = -(this.offsetWidth / 2) + this.clientWidth / 2 + "px", this.style[Transformie.centerOrigin == "margin" ? "marginTop" : "top"] = -(this.offsetHeight / 2) + this.clientHeight / 2 + "px")
        })
    }
};
(function (a) {function b(a) {
    ...
    var b = window.MINUTE_KEY || b || {};
    b = {
        init: function () {
            b.locatorToggle(), b.openLocatorToggle(), b.machineSlideshow(), b.videoSlideshow(), b.smoothScroll(), b.keyCounter(), b.adminFunctions()
        },
        locatorToggle: function () {
            a("#locator").length > 0 && a(".locator a").click(function () {
                a("#nav .locator").toggleClass("open"), a("#nav .locator a").toggleClass("blue"), a("#nav .locator a").toggleClass("red"), a("#locator").toggleClass("hidden"), a("#content").toggleClass("hidden"), a("#nav").toggleClass("bottom"), a("#nav").toggleClass("top"), a("html, body").animate({
                    scrollTop: "0px"
                }, {
                    duration: 1e3,
                    easing: "swing"
        ...
        openLocatorToggle: function () {
            a("#locator").length > 0 && (a("#nav a.button.small").click(function () {
                a("#nav .locator.open").length > 0 && (a("#nav .locator").toggleClass("open"), a("#nav .locator a").toggleClass("blue"), a("#nav .locator a").toggleClass("red"), a("#locator").toggleClass("hidden"), a("#content").toggleClass("hidden"), a("#nav").toggleClass("bottom"), a("#nav").toggleClass("top"))
            }), a("#locator .close_link").click(function () {
                a("#nav .locator.open").length > 0 && (a("#nav .locator").toggleClass("open"), a("#nav .locator a").toggleClass("blue"), a("#nav .locator a").toggleClass("red"), a("#locator").toggleClass("hidden"), a("#content").toggleClass("hidden"), a("#nav").toggleClass("bottom"), a("#nav").toggleClass("top"))
            }))
        },
        machineSlideshow: function () {
            a("#machine").length > 0 && a("#machine .content .subnav a").click(function () {
                var b = a(this).data("machine");
                a("#machine .content .machine_container").children().fadeOut(), a("#machine .content .machine_container #machine_" + b).fadeIn(), a("#machine .content .subnav ul").children().removeClass("current"), a(this).parent().addClass("current")
            })
        },
        videoSlideshow: function () {
            a("#video").length > 0 && a("#video .content .subnav a").click(function () {
                var b = a(this).data("video"),
                    c = a(this).data("title");
                a("#video .content .video_container").children().fadeOut(), a("#video .content .video_container #video_" + b).fadeIn(), a("#video .content .subnav ul").children().removeClass("current"), a(this).parent().addClass("current"), a("#video .video_title").text(c)
            })
        },
        smoothScroll: function () {
            a("a.smoothscroll").click(function () {
                var b = a(a(this).attr("href")).offset();
                return b == null ? !1 : (a("html, body").animate({
                    scrollTop: b.top - 130 + "px"
                }, {
                    duration: 1e3,
                    easing: "swing"
                }), !1)
        ...
        fixedNav: function () {},
        keyCounter: function () {
            if (a("#keycounter").length > 0) {
                var b = 1,
                    c = a("#keycounter").data("start_point"),
                    d = a("#keycounter").data("count_rate"),
                    e = b * parseInt(60 / d * 1e3),
                    f = a("#keycounter"),
                    g = parseInt(c, 10);
        ...
        adminFunctions: function () {
            if (a("#add_new").length > 0) {
                var b = a(".add_new_toggle").text();
                a(".add_new_toggle").click(function () {
                    a("#add_new").toggle("fade"), a(this).text() === "X Cancel" ? a(this).text(b) : a(this).text("X Cancel"), a(this).toggleClass("small"), a(this).toggleClass("green")
                })
            }
            a("#machine_layout_type").length > 0 && a("#machine_layout_type").change(function () {
                var b = a("#machine_layout_type").val();
                b === "Full Image" && (a("form p.embed").hide(), a("form p.content").hide(), a("form p.image").show(), a("form .note.big").show(), a("form .note.small").hide(), a("form .image_link").show()), b === "Half / Image Left" && (a("form p.embed").hide(), a("form p.content").show(), a("form p.image").show(), a("form .note.big").hide(), a("form .note.small").show(), a("form .image_link").show()), b === "Half / Image Right" && (a("form p.embed").hide(), a("form p.content").show(), a("form p.image").show(), a("form .note.big").hide(), a("form .note.small").show(), a("form .image_link").show()), b === "Full Video" && (a("form p.embed").show(), a("form p.content").hide(), a("form p.image").hide(), a("form .note.big").show(), a("form .note.small").hide(), a("form .image_link").hide()), b === "Half / Video Left" && (a("form p.embed").show(), a("form p.content").show(), a("form p.image").hide(), a("form .note.big").hide(), a("form .note.small").show(), a("form .image_link").hide()), b === "Half / Video Right" && (a("form p.embed").show(), a("form p.content").show(), a("form p.image").hide(), a("form .note.big").hide(), a("form .note.small").show(), a("form .image_link").hide())
            }), a("#video_layout_type").length > 0 && a("#video_layout_type").change(function () {
                var b = a("#video_layout_type").val();
                b === "Full Video" && (a("form p.content").hide(), a("form .note.big").show(), a("form .note.small").hide()), b === "Half / Video Left" && (a("form p.content").show(), a("form .note.big").hide(), a("form .note.small").show()), b === "Half / Video Right" && (a("form p.content").show(), a("form .note.big").hide(), a("form .note.small").show())
            })
        }
    }, window.MINUTE_KEY = b, a(document).ready(b.init)
}(jQuery), $(function () {
    if ($("#coverflow").length > 0) {
        ...
        a = {
            ...
            imageCaption: $("#keygallery #imageCaption"),
            sliderCtrl: $("#keygallery #slider"),
            coverflowCtrl: $("#keygallery #coverflow"),
            coverflowImages: $("#keygallery #coverflow").find("img"),
            coverflowItems: $("#keygallery .coverflowItem"),
            sliderVertical: $("#keygallery #slider-vertical"),
            origSliderHeight: "",
            sliderHeight: "",
            sliderMargin: "",
            difference: "",
            ...
            getItems: function () {
                var a = $("#keygallery .coverflowItem");
                return a
            },
            skipTo: function (a) {
                var b = $(".coverflowItem");
